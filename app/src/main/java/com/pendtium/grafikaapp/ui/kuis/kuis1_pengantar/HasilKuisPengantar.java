package com.pendtium.grafikaapp.ui.kuis.kuis1_pengantar;
...
public class HasilKuisPengantar extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hasil.setText("Jawaban Benar : "+ KuisPengantar.benar+"\n Jawaban Salah : " + KuisPengantar.salah);
        nilai.setText(""+ KuisPengantar.hasil);
        if (KuisPengantar.hasil >= 70){
    ...
    public void ulangi(View view){
        ...
        dial.setMessage("Ulangi Kuis?")
                .setPositiveButton("Ya", (dialog, which) -> {
                    finish();
                    Intent i = new Intent(getApplicationContext(), KuisPengantar.class);
                    startActivity(i);
                })
