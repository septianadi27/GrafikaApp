...
import com.pendtium.grafikaapp.ui.materi.Materi4Transformasi.ContohFragment;
import com.pendtium.grafikaapp.ui.materi.Materi4Transformasi.DefinisiFragment;
import com.pendtium.grafikaapp.ui.materi.Materi4Transformasi.ImplementasiFragment;

import java.util.ArrayList;
import java.util.List;

public class Materi4TabsActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        Materi4TabsActivity.ViewPagerAdapter adapter = new Materi4TabsActivity.ViewPagerAdapter(getSupportFragmentManager());
