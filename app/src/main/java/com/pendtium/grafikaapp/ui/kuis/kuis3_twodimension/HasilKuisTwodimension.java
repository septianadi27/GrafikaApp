...
public class HasilKuisTwodimension extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hasil.setText("Jawaban Benar : "+ KuisTwodimension.benar+"\n Jawaban Salah : " + KuisTwodimension.salah);
        nilai.setText(""+ KuisTwodimension.hasil);
        if (KuisTwodimension.hasil >= 60){
...
//            dial.setTitle("Yakin?");
        dial.setMessage("Ulangi Kuis?")
                .setPositiveButton("Ya", (dialog, which) -> {
                    finish();
                    Intent i = new Intent(getApplicationContext(), KuisTwodimension.class);
                    startActivity(i);
                })
