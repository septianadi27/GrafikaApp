...
public class HasilKuisInteraksi extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hasil.setText("Jawaban Benar : "+ KuisInteraksi.benar+"\n Jawaban Salah : " + KuisInteraksi.salah);
        nilai.setText(""+ KuisInteraksi.hasil);
        if (KuisInteraksi.hasil >= 70){
    ...
    public void ulangi(View view){
        ...
        dial.setMessage("Ulangi Kuis?")
                .setPositiveButton("Ya", (dialog, which) -> {
                    finish();
                    Intent i = new Intent(getApplicationContext(), KuisInteraksi.class);
                    startActivity(i);
                })
