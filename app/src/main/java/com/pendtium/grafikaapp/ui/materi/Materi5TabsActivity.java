...
import com.pendtium.grafikaapp.ui.materi.Materi5Interaksi.ContohFragment;
import com.pendtium.grafikaapp.ui.materi.Materi5Interaksi.DefinisiFragment;
import com.pendtium.grafikaapp.ui.materi.Materi5Interaksi.ImplementasiFragment;

import java.util.ArrayList;
import java.util.List;

public class Materi5TabsActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        Materi5TabsActivity.ViewPagerAdapter adapter = new Materi5TabsActivity.ViewPagerAdapter(getSupportFragmentManager());
