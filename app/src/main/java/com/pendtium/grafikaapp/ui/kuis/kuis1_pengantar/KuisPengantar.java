...
public class KuisPengantar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis1_pengantar);
    ...
    public void next(View view){
        ...
        if (PilA.isChecked() || PilB.isChecked() || PilC.isChecked() || PilD.isChecked()) {
            ...
            if (nomor < pertanyaan_kuis.length) {
                ...
                hasil = benar * 10;
                Intent selesai = new Intent(getApplicationContext(), HasilKuisPengantar.class);
